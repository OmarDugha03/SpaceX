      ...
      <div className='relative mx-auto h-full  w-full max-w-7xl overflow-hidden px-4 md:h-[40rem]'>
        ...
        >
          <h2 className=' text-center text-xl font-bold text-black dark:text-white md:text-4xl'>
            Whether it’s crafting pixel-perfect UIs or taming unruly APIs, I’m
            your go-to dev. Let’s build something amazing together! 🎉
          </h2>
          <Link
            href='https://www.linkedin.com/in/omar-dugha-5495222aa'
            className='mx-auto mt-12 flex w-fit max-w-md cursor-default justify-center rounded-lg bg-violet-500 p-1 text-center text-base font-normal text-neutral-700 hover:bg-violet-500/20 dark:text-neutral-200 md:text-lg'
          >
